...
export const ORDER_GET_MY_ORDERS_REQUEST = 'ORDER_GET_MY_ORDERS_REQUEST';
export const ORDER_GET_MY_ORDERS_SUCCESS = 'ORDER_GET_MY_ORDERS_SUCCESS';
export const ORDER_GET_MY_ORDERS_FAIL = 'ORDER_GET_MY_ORDERS_FAIL';
export const ORDER_GET_MY_ORDERS_RESET = 'ORDER_GET_MY_ORDERS_RESET';
